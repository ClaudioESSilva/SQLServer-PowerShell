...
/* 
	Check the contents 
	Scroll to the end and check the new column was written
*/
DBCC TRACEON (3604);
GO
DBCC PAGE (N'XRaying', 1, 411, 3);
GO
...
SELECT *
  FROM sys.dm_db_database_page_allocations(DB_ID('XRaying'), OBJECT_ID(N'dbo.ClientSmallerBio'), NULL, NULL, N'Limited')
 WHERE allocated_page_page_id = 24265
GO

/*
	The "blob Id:" is the link
*/
DBCC PAGE (N'XRaying', 1, 24265, 3);
GO
